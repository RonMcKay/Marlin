...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 161.61
  #define DEFAULT_bedKi 29.41
  #define DEFAULT_bedKd 592.08
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2133.33, 798 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 25, 0, -1.33 }
...
#define XY_PROBE_FEEDRATE 9000

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (4*60)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST * 2 / 3)
